...
# from https://github.com/ufal/whisper_streaming/blob/7f37945bdb0162307c26119f51bd58dd27eb710a/whisper_online.py

# edit "import librosa" commentout
# edit "import soundfile as sf" commentout
# edit "async def process_iter(self)" to "def process_iter(self):"
# edit "res = await self.asr.transcribe(self.audio_buffer, init_prompt=prompt)" to "res = self.asr.transcribe(self.audio_buffer, init_prompt=prompt)"

import sys
import numpy as np
# import librosa  # use main
...
import io
# import soundfile as sf # use openai
import math
...
class OnlineASRProcessor:
    ...
    async def process_iter(self):
        ...
        res = await self.asr.transcribe(self.audio_buffer, init_prompt=prompt)
